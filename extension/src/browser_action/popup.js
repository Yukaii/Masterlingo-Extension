...
chrome.runtime.sendMessage({ method: 'get', function: 'config' }, function(response) {
  if (response.loggedIn) {
    ...
    rootSelector.innerHTML = `<div class="logo">Master<span>Lingo</span></div><div class="sign-in"> Sign in to start using the extension. </div><a href="https://masterlingoapp.com/signin" class="button log-in">Sign in</a>`;
