...
/* harmony import */ var _responsiveVoice__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./responsiveVoice */ "./src/content/responsiveVoice.js");
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _responsiveVoice__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./responsiveVoice */ "./src/content/responsiveVoice.js");
...
if ('undefined' != typeof responsiveVoice) console.log('ResponsiveVoice already loaded'), console.log(responsiveVoice);
  ...
  var ResponsiveVoice = function() {
      ...
      a.speak = function(b, c, d) {
        if (a.rvsMapped) {
          ...
          if (a.isPlaying())
            ...
            !0 === g.deprecated &&
              console.warn(
                'ResponsiveVoice: Voice ' + g.name + ' is deprecated and will be removed in future releases'
              );
            f = {};
              ...
              for (g = 0; g < k.length; g++)
                if (!a.fallbackMode && a.getServiceEnabled(a.services.NATIVE_TTS))
                  a.log('Using SpeechSynthesis'),
                    ...
                    (e.volume = a.selectBest([f.collectionvoice.volume, f.systemvoice.volume, 1])),
                    (e.rate = a.selectBest([a.iOS9plus ? 1 : null, f.collectionvoice.rate, f.systemvoice.rate, 1])),
                    (e.pitch = a.selectBest([f.collectionvoice.pitch, f.systemvoice.pitch, 1])),
                    (e.text = k[g]),
                    ...
                    null != d
                      ? ((e.voice = 'undefined' !== typeof d.voice ? d.voice : f.systemvoice),
                        g < k.length - 1 && 1 < k.length
                          ? ((e.onend = a.onPartEnd),
                            e.hasOwnProperty('addEventListener') && e.addEventListener('end', a.onPartEnd))
                          : ((e.onend = a.speech_onend),
                            e.hasOwnProperty('addEventListener') && e.addEventListener('end', a.speech_onend)),
                        (e.onerror =
                          d.onerror ||
                          function(b) {
      ...
      a.fallback_startPart = function() {
        ...
        null == a.fallback_audio
          ...
          : ((function() {
            ...
            a.useTimer && a.startTimeout(a.multipartText[a.fallbackChunkIndex], a.fallback_finishPart));
      };
        ...
        for (var c = 0; c < a.responsivevoices.length; c++)
          if (a.responsivevoices[c].name == b)
            return (
              (b = a.fallbackMode),
              (a.fallbackMode =
                !0 === a.responsivevoices[c].mappedProfile.collectionvoice.fallbackvoice || !0 === a.forcedFallbackMode
                  ? !0
                  : !1),
      ...
      a.initFallbackPool = function() {
        if (!a.fallback_audiopool || 0 == a.fallback_audiopool.length) {
          for (var b = 0; 10 > b; b++) {
            ...
            a.iOS &&
              ((d.src = ''), d.load(), 9 == c && (a.log('iOS HTML audio initialized'), (a.iOS_initialized = !0)));
      ...
      a.checkSpeechAllowed = function(b) {
        ...
        if (
          (a.is_android || a.iOS || (a.is_safari && (a.fallbackMode || a.forcedFallbackMode))) &&
      ...
      a.validateParameters = function(a, c) {
        ...
        switch (c) {
          ...
          case 'volume':
            ...
            isNaN(b) &&
              console.warn(
                'ResponsiveVoice: the parameter ' + c + ' has a wrong value "' + a[c] + '". Defaults were used.'
              );
            a[c] = isNaN(b) ? '1' : a[c];
        }
        return a[c];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const addSubtractDate = __webpack_require__(/*! add-subtract-date */ "./node_modules/add-subtract-date/lib/index.js");
