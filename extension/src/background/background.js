...
/* harmony import */ var _msLingoApi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./msLingoApi */ "./src/background/msLingoApi.js");
...
class Flashcards {
  ...
  deleteFlashcard(flashcardId, deleteFromDb = false) {
    this.reviewFlashcards = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.omit(this.reviewFlashcards, flashcardId);
    if (deleteFromDb) {
  ...
  addFlashcard(flashcard) {
    this.reviewFlashcards[flashcard._id] = flashcard;
    _msLingoApi__WEBPACK_IMPORTED_MODULE_0__["default"].addFlashcard(flashcard);
  }
}
...
async function init() {
  const user = await _msLingoApi__WEBPACK_IMPORTED_MODULE_1__["default"].login();
  if (user) {
    ...
    case 'put':
      switch (request.function) {
        ...
        case 'flashcards':
          ...
          flashcards = {
            allFlashcards: lodash__WEBPACK_IMPORTED_MODULE_2___default.a.mapKeys(receivedFlashcards, '_id'),
            reviewFlashcards: lodash__WEBPACK_IMPORTED_MODULE_2___default.a.mapKeys(reviewFlashcards, '_id')
          };
